...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, dataset, num_classes=10):
...
class PreActResNet(nn.Module):
    def __init__(self, block, num_blocks, dataset, num_classes=10, bn_before_fc=False, out_shortcut=False):
...
def ResNet34(num_classes, dataset):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=num_classes, dataset=dataset)


def ResNet50(num_classes, dataset):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, dataset=dataset)


def ResNet101(num_classes, dataset):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, dataset=dataset)


def ResNet152(num_classes, dataset):
    return ResNet(Bottleneck, [3, 8, 36, 3], num_classes=num_classes, dataset=dataset)


def PreActResNet18(num_classes, dataset):
    return PreActResNet(PreActBlock, [2, 2, 2, 2], num_classes=num_classes, dataset=dataset)
